    ...
    return function (_Component) {
      ...
      _createClass(_class, [{
        ...
        value: function render() {
          ...
          var cn = (0, _className.mergeClassName)(this.props, [flex ? flatWithPrefix(flex, 'flex-') : '', justifyContent ? flatWithPrefix(justifyContent, 'justify-content-') : '', alignItems ? flatWithPrefix(alignItems, 'align-items-') : '', alignContent ? flatWithPrefix(alignContent, 'align-content-') : '', alignSelf ? flatWithPrefix(alignSelf, 'align-self-') : '', flexGrow ? flatWithPrefix(flexGrow, 'flex-grow-') : '', flexShrink ? flatWithPrefix(flexShrink, 'flex-shrink-') : '', order ? flatWithPrefix(order, 'order-') : '']);
